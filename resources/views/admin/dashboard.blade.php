    ...
    <head>
        ...
        <script>
            ...
            window.posConfig = {
                ...
                checkoutUrl: @json(route('admin.orders.store')),
                calculateUrl: @json(route('admin.orders.calculate')),
                historyUrl: @json(route('admin.riwayat'))
            };
        </script>
        ...
        <div class="modal success-modal hidden" data-success-modal>
            <section class="success-panel">
                ...
                <div class="success-actions">
                    <button type="button" class="btn-share" data-share-receipt>Lihat Struk</button>
